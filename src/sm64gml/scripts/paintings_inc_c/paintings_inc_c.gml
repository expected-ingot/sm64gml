function paintings_inc_c_init() {
/// <pygml?v=1.0&h=546d008b7>
// 0x07021800 - 0x07021818
inside_castle_seg7_lights_07021800 = gdSPDefLights1(
    0x50, 0x50, 0x50,
    0xff, 0xff, 0xff, 0x32, 0x32, 0x32
);

// 0x07021818 - 0x07021898
inside_castle_seg7_vertex_07021818 = vList(
    Vtx([     0,      0,      0], 0, [   -32,    992], [0x00, 0x00, 0x7f, 0xff]),
    Vtx([   614,      0,      0], 0, [  2012,    992], [0x00, 0x00, 0x7f, 0xff]),
    Vtx([   614,    307,      0], 0, [  2012,      0], [0x00, 0x00, 0x7f, 0xff]),
    Vtx([     0,    307,      0], 0, [   -32,      0], [0x00, 0x00, 0x7f, 0xff]),
    Vtx([     0,    307,      0], 0, [   -32,    992], [0x00, 0x00, 0x7f, 0xff]),
    Vtx([   614,    307,      0], 0, [  2012,    992], [0x00, 0x00, 0x7f, 0xff]),
    Vtx([   614,    614,      0], 0, [  2012,    -28], [0x00, 0x00, 0x7f, 0xff]),
    Vtx([     0,    614,      0], 0, [   -32,    -28], [0x00, 0x00, 0x7f, 0xff]),
);

// 0x07021898 - 0x07021918
inside_castle_seg7_vertex_07021898 = vList(
    Vtx([     0,      0,      0], 0, [   -32,    992], [0xdd, 0xdd, 0xdd, 0xff]),
    Vtx([   614,      0,      0], 0, [  2012,    992], [0xdd, 0xdd, 0xdd, 0xff]),
    Vtx([   614,    307,      0], 0, [  2012,      0], [0xdd, 0xdd, 0xdd, 0xff]),
    Vtx([     0,    307,      0], 0, [   -32,      0], [0xdd, 0xdd, 0xdd, 0xff]),
    Vtx([     0,    307,      0], 0, [   -32,    992], [0xdd, 0xdd, 0xdd, 0xff]),
    Vtx([   614,    307,      0], 0, [  2012,    992], [0xdd, 0xdd, 0xdd, 0xff]),
    Vtx([   614,    614,      0], 0, [  2012,    -28], [0xdd, 0xdd, 0xdd, 0xff]),
    Vtx([     0,    614,      0], 0, [   -32,    -28], [0xdd, 0xdd, 0xdd, 0xff]),
);

// 0x07021918 - 0x07021998
inside_castle_seg7_vertex_07021918 = vList(
    Vtx([ -3046,   -307,  -3724], 0, [   -32,    992], [0x00, 0x00, 0x7f, 0xff]),
    Vtx([ -2742,   -307,  -4258], 0, [  2012,    992], [0x00, 0x00, 0x7f, 0xff]),
    Vtx([ -2742,      0,  -4258], 0, [  2012,      0], [0x00, 0x00, 0x7f, 0xff]),
    Vtx([ -3046,      0,  -3724], 0, [   -32,      0], [0x00, 0x00, 0x7f, 0xff]),
    Vtx([ -3046,      0,  -3724], 0, [   -32,    992], [0x00, 0x00, 0x7f, 0xff]),
    Vtx([ -2742,      0,  -4258], 0, [  2012,    992], [0x00, 0x00, 0x7f, 0xff]),
    Vtx([ -2742,    307,  -4258], 0, [  2012,      0], [0x00, 0x00, 0x7f, 0xff]),
    Vtx([ -3046,    307,  -3724], 0, [   -32,      0], [0x00, 0x00, 0x7f, 0xff]),
);

// 0x07021998 - 0x07021A18
inside_castle_seg7_vertex_07021998 = vList(
    Vtx([ -1866,   -307,  -4258], 0, [   -32,    992], [0x00, 0x00, 0x7f, 0xff]),
    Vtx([ -1562,   -307,  -3724], 0, [  2012,    992], [0x00, 0x00, 0x7f, 0xff]),
    Vtx([ -1562,      0,  -3724], 0, [  2012,      0], [0x00, 0x00, 0x7f, 0xff]),
    Vtx([ -1866,      0,  -4258], 0, [   -32,      0], [0x00, 0x00, 0x7f, 0xff]),
    Vtx([ -1866,      0,  -4258], 0, [   -32,    992], [0x00, 0x00, 0x7f, 0xff]),
    Vtx([ -1562,      0,  -3724], 0, [  2012,    992], [0x00, 0x00, 0x7f, 0xff]),
    Vtx([ -1562,    307,  -3724], 0, [  2012,      0], [0x00, 0x00, 0x7f, 0xff]),
    Vtx([ -1866,    307,  -4258], 0, [   -32,      0], [0x00, 0x00, 0x7f, 0xff]),
);

// 0x07021A18 - 0x07021A30
inside_castle_seg7_dl_07021A18 = dList(
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSPEndDisplayList(),
);

// 0x07021A30 - 0x07021A48
inside_castle_seg7_dl_07021A30 = dList(
    gsSP2Triangles( 4,  5,  6, 0x0,  4,  6,  7, 0x0),
    gsSPEndDisplayList(),
);

// 0x07021A48 - 0x07021AA0
inside_castle_seg7_dl_07021A48 = dList(
    //gsDPPipeSync(),
    gsSPSetGeometryMode(G_LIGHTING | G_SHADING_SMOOTH),
    gsDPSetCombineMode(G_CC_MODULATERGB, G_CC_MODULATERGB),
    gsSPLight(inside_castle_seg7_lights_07021800.l[0], 1),
...
inside_castle_seg7_dl_07021AA0 = dList(
...
inside_castle_seg7_painting_dl_07021AC0 = dList(
    //gsDPTileSync(),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 0, G_TX_RENDERTILE, 0, G_TX_CLAMP, 5, G_TX_NOLOD, G_TX_CLAMP, 6, G_TX_NOLOD),
    gsDPSetTileSize(0, 0, 0, (64 - 1) << G_TEXTURE_IMAGE_FRAC, (32 - 1) << G_TEXTURE_IMAGE_FRAC),
    gsSPEndDisplayList(),
...
inside_castle_seg7_painting_texture_map_bottom_07021AE0 = PaintingData(
    85, // num mappings
    // Format:
...
inside_castle_seg7_painting_texture_map_top_07021FFC = PaintingData(
    85, // num mappings
    // Format:
    // mesh vtx ID, texture X, texture Y
       0, 2016,   72,
...
castle_inside_unused_0 = 0x0;

/// <pygml?v=1.0&h=06ced474c>
inside_castle_seg7_lights_07022528 = gdSPDefLights1(
    0x50, 0x50, 0x50,
    0xff, 0xff, 0xff, 0x32, 0x32, 0x32
);
...
inside_castle_seg7_lights_07022540 = [
	gdSPDefLights1(0x40, 0x40, 0x80, 0x40, 0x40, 0x80, 0, 0, 0),
	gdSPDefLights1(0x64, 0x64, 0xff, 0x64, 0x64, 0xfa, 0x28, 0x28, 0x28),
]; // @z

// 0x07022558 - 0x07022598
inside_castle_seg7_vertex_07022558 = vList(
    Vtx([     0,      0,      0], 0, [   -32,    990], [0x00, 0x00, 0x7f, 0xff]),
    Vtx([   614,      0,      0], 0, [  6100,    990], [0x00, 0x00, 0x7f, 0xff]),
    Vtx([   614,    614,      0], 0, [  6100,  -5142], [0x00, 0x00, 0x7f, 0xff]),
    Vtx([     0,    614,      0], 0, [   -32,  -5142], [0x00, 0x00, 0x7f, 0xff]),
);

// 0x07022598 - 0x070225D8
inside_castle_seg7_vertex_07022598 = vList(
    Vtx([     0,      0,      0], 0, [     0,      0], [0x00, 0x00, 0x7f, 0xff]),
    Vtx([   614,      0,      0], 0, [     0,      0], [0x00, 0x00, 0x7f, 0xff]),
    Vtx([   614,    614,      0], 0, [     0,      0], [0x00, 0x00, 0x7f, 0xff]),
    Vtx([     0,    614,      0], 0, [     0,      0], [0x00, 0x00, 0x7f, 0xff]),
);

/// <pygml?v=1.0&h=5aa86dbb2>
inside_castle_seg7_painting_dl_07022640 = dList(
    //gsDPTileSync(),
...
inside_castle_seg7_painting_env_map_texture_map_07022660 = PaintingData(
  157, // num mappings
    // Format:
    // mesh vtx ID, texture X, texture Y
       0, 6100, -4832,
...
/// <pygml?v=1.0&h=bcc096476>
// 0x07023050 - 0x070230B0
inside_castle_seg7_painting_dl_07023050 = dList(
...
inside_castle_seg7_painting_dl_070230B0 = dList(
    gsSPDisplayList(inside_castle_seg7_dl_07021A48),
    gsSPVertex(inside_castle_seg7_vertex_07021818, 8, 0),
...
inside_castle_seg7_painting_dl_07023110 = dList(
    gsSPDisplayList(inside_castle_seg7_dl_07021A48),
    gsSPVertex(inside_castle_seg7_vertex_07021818, 8, 0),
...
inside_castle_seg7_painting_dl_07023170 = dList(
    gsSPDisplayList(inside_castle_seg7_dl_07021A48),
    gsSPVertex(inside_castle_seg7_vertex_07021818, 8, 0),
...
inside_castle_seg7_painting_dl_070231D0 = dList(
    gsSPDisplayList(inside_castle_seg7_dl_07021A48),
    gsSPVertex(inside_castle_seg7_vertex_07021818, 8, 0),
...
inside_castle_seg7_painting_dl_07023230 = dList(
    gsSPDisplayList(inside_castle_seg7_dl_07021A48),
    gsSPVertex(inside_castle_seg7_vertex_07021818, 8, 0),
...
inside_castle_seg7_painting_dl_07023290 = dList(
    gsSPDisplayList(inside_castle_seg7_dl_07021A48),
    gsSPVertex(inside_castle_seg7_vertex_07021818, 8, 0),
...
inside_castle_seg7_painting_dl_070232F0 = dList(
    gsSPDisplayList(inside_castle_seg7_dl_07021A48),
    gsSPVertex(inside_castle_seg7_vertex_07021818, 8, 0),
...
inside_castle_seg7_painting_dl_07023350 = dList(
    gsSPDisplayList(inside_castle_seg7_dl_07021A48),
    gsSPVertex(inside_castle_seg7_vertex_07021818, 8, 0),
...
inside_castle_seg7_painting_dl_070233B0 = dList(
    gsSPDisplayList(inside_castle_seg7_dl_07021A48),
    gsSPVertex(inside_castle_seg7_vertex_07021818, 8, 0),
...
inside_castle_seg7_painting_dl_07023410 = dList(
    //gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGB, G_CC_MODULATERGB),
...
inside_castle_seg7_dl_070234C0 = dList(
    gsSPDisplayList(inside_castle_seg7_dl_07021A48),
...
inside_castle_seg7_dl_07023520 = dList(
    gsSPDisplayList(inside_castle_seg7_dl_07021A48),
...
inside_castle_seg7_painting_dl_07023580 = dList(
    //gsDPPipeSync(),
    gsSPLight(inside_castle_seg7_lights_07022540[0].l[0], 1), // @z
    gsSPLight(inside_castle_seg7_lights_07022540[0].a, 2), // @z
...
inside_castle_seg7_painting_dl_070235B8 = gsSPBranchList(inside_castle_seg7_painting_dl_07023580);
...
/// <pygml?v=1.0&h=239735ded>
// 0x07023620 - 0x07023698
global.__bob_painting = new Painting([
    /* id */ 0x0000,
    /* Image Count */ 0x02,
    ...
    /*                         curr   passive     entry */
    /* Ripple Magnitude */     0.0,    20.0,    80.0,
    /* Ripple Decay */         1.0,  0.9608,  0.9524,
    /* Ripple Rate */          0.0,    0.24,    0.14,
    /* Ripple Dispersion */    0.0,    40.0,    30.0,
...
/// <pygml?v=1.0&h=75b60b5f6>
// 0x07023698 - 0x07023710
global.__ccm_painting = new Painting([
    /* id */ 0x0001,
    /* Image Count */ 0x02,
    /* Texture Type */ PAINTING_IMAGE,
    /* Floor Status */ 0x00, 0x00, 0x00 /* which of the painting's nearby special floors Mario's on */,
...
global.__wf_painting = new Painting([
    /* id */ 0x0002,
    /* Image Count */ 0x02,
    /* Texture Type */ PAINTING_IMAGE,
    /* Floor Status */ 0x00, 0x00, 0x00 /* which of the painting's nearby special floors Mario's on */,
...
global.__jrb_painting = new Painting([
    /* id */ 0x0003,
    /* Image Count */ 0x02,
    /* Texture Type */ PAINTING_IMAGE,
    /* Floor Status */ 0x00, 0x00, 0x00 /* which of the painting's nearby special floors Mario's on */,
...
global.__lll_painting = new Painting([
    /* id */ 0x0004,
    /* Image Count */ 0x02,
    /* Texture Type */ PAINTING_IMAGE,
    /* Floor Status */ 0x00, 0x00, 0x00 /* which of the painting's nearby special floors Mario's on */,
...
global.__ssl_painting = new Painting([
    /* id */ 0x0005,
    /* Image Count */ 0x02,
    /* Texture Type */ PAINTING_IMAGE,
    /* Floor Status */ 0x00, 0x00, 0x00 /* which of the painting's nearby special floors Mario's on */,
...
global.__hmc_painting = new Painting([
    /* id */ 0x000E,
    /* Image Count */ 0x01,
...
global.__ddd_painting = new Painting([
    /* id */ 0x0007,
    /* Image Count */ 0x01,
    /* Texture Type */ PAINTING_ENV_MAP,
    /* Floor Status */ 0x00, 0x00, 0x00 /* which of the painting's nearby special floors Mario's on */,
...
global.__wdw_painting = new Painting([
    /* id */ 0x0008,
    /* Image Count */ 0x02,
    /* Texture Type */ PAINTING_IMAGE,
    /* Floor Status */ 0x00, 0x00, 0x00 /* which of the painting's nearby special floors Mario's on */,
...
global.__thi_tiny_painting = new Painting([
    /* id */ 0x0009,
    /* Image Count */ 0x02,
    /* Texture Type */ PAINTING_IMAGE,
    /* Floor Status */ 0x00, 0x00, 0x00 /* which of the painting's nearby special floors Mario's on */,
...
global.__ttm_painting = new Painting([
    /* id */ 0x000A,
    /* Image Count */ 0x02,
    /* Texture Type */ PAINTING_IMAGE,
    /* Floor Status */ 0x00, 0x00, 0x00 /* which of the painting's nearby special floors Mario's on */,
...
global.__ttc_painting = new Painting([
    /* id */ 0x000B,
    /* Image Count */ 0x02,
    /* Texture Type */ PAINTING_IMAGE,
    /* Floor Status */ 0x00, 0x00, 0x00 /* which of the painting's nearby special floors Mario's on */,
...
global.__sl_painting = new Painting([
    /* id */ 0x000C,
    /* Image Count */ 0x02,
    /* Texture Type */ PAINTING_IMAGE,
    /* Floor Status */ 0x00, 0x00, 0x00 /* which of the painting's nearby special floors Mario's on */,
...
global.__thi_huge_painting = new Painting([
    /* id */ 0x000D,
    /* Image Count */ 0x02,
    /* Texture Type */ PAINTING_IMAGE,
    /* Floor Status */ 0x00, 0x00, 0x00 /* which of the painting's nearby special floors Mario's on */,
    ...
    /*                         curr   passive     entry */
    /* Ripple Magnitude */     0.0,    40.0,   160.0,
    /* Ripple Decay */         1.0,  0.9608,  0.9524,
    /* Ripple Rate */          0.0,    0.12,    0.07,
    /* Ripple Dispersion */    0.0,    80.0,    60.0,
    /* Curr Ripple Timer */    0.0,
    /* Curr Ripple x, y */     0.0,    0.0,
    /* Normal DList */ inside_castle_seg7_painting_dl_070232F0,
    /* Texture Maps */ inside_castle_seg7_painting_texture_maps_07022518,
...
#macro bob_painting			   global.__bob_painting
#macro ccm_painting			   global.__ccm_painting
#macro wf_painting			   global.__wf_painting
#macro jrb_painting			   global.__jrb_painting
#macro lll_painting			   global.__lll_painting
#macro ssl_painting			   global.__ssl_painting
#macro hmc_painting			   global.__hmc_painting
#macro ddd_painting			   global.__ddd_painting
#macro wdw_painting			   global.__wdw_painting
#macro thi_tiny_painting	   global.__thi_tiny_painting
#macro ttm_painting			   global.__ttm_painting
#macro ttc_painting			   global.__ttc_painting
#macro sl_painting			   global.__sl_painting
#macro thi_huge_painting	   global.__thi_huge_painting
}