function castle_inside_geo_init(){
// 0x07068B88 - 0x0706E362
inside_castle_seg7_area_1_collision = cList(
    COL_INIT(),
...
/// <pygml?v=1.0&h=3826f65c0>
// 0x0E000F30
castle_geo_000F30 = gList(
   [GCMD_START],
   [GCMD_OPEN],
      [GCMD_DLIST, LAYER_OPAQUE, inside_castle_seg7_dl_07028FD0],
      [GCMD_DLIST, LAYER_ALPHA, inside_castle_seg7_dl_07029578],
      [GCMD_DLIST, LAYER_OPAQUE, inside_castle_seg7_dl_0702A650],
      [GCMD_DLIST, LAYER_TRANSPARENT_DECAL, inside_castle_seg7_dl_0702AA10],
      [GCMD_DLIST, LAYER_ALPHA, inside_castle_seg7_dl_0702AB20],
      //[GCMD_ASM, 0, geo_exec_inside_castle_light],
   [GCMD_CLOSE],
   [GCMD_RETURN],
);

// 0x0E000F70
castle_geo_000F70 = gList(
   [GCMD_START],
   [GCMD_OPEN],
      [GCMD_DLIST, LAYER_OPAQUE, inside_castle_seg7_dl_0702E408],
   [GCMD_CLOSE],
   [GCMD_RETURN],
);

// 0x0E000F88
castle_geo_000F88 = gList(
   [GCMD_START],
   [GCMD_OPEN],
      [GCMD_DLIST, LAYER_OPAQUE, inside_castle_seg7_dl_0702FD30],
      [GCMD_DLIST, LAYER_OPAQUE, inside_castle_seg7_dl_07023DB0],
   [GCMD_CLOSE],
   [GCMD_RETURN],
);

// 0x0E000FA8
castle_geo_000FA8 = gList(
   [GCMD_START],
   [GCMD_OPEN],
      [GCMD_DLIST, LAYER_OPAQUE, inside_castle_seg7_dl_07031588],
      [GCMD_DLIST, LAYER_ALPHA, inside_castle_seg7_dl_07031720],
      [GCMD_DLIST, LAYER_ALPHA, inside_castle_seg7_dl_07031830],
   [GCMD_CLOSE],
   [GCMD_RETURN],
);

// 0x0E000FD0
castle_geo_000FD0 = gList(
   [GCMD_START],
   [GCMD_OPEN],
      [GCMD_DLIST, LAYER_OPAQUE, inside_castle_seg7_dl_07032FC0],
      [GCMD_DLIST, LAYER_ALPHA, inside_castle_seg7_dl_07033158],
      //[GCMD_ASM,   0, geo_painting_update],
      //[GCMD_ASM, PAINTING_ID, 0, 1], geo_painting_draw],
   [GCMD_CLOSE],
   [GCMD_RETURN],
);

// 0x0E001000
castle_geo_001000 = gList(
   [GCMD_START],
   [GCMD_OPEN],
      [GCMD_DLIST, LAYER_OPAQUE, inside_castle_seg7_dl_07034D88],
      [GCMD_DLIST, LAYER_ALPHA, inside_castle_seg7_dl_07035178],
      [GCMD_DLIST, LAYER_ALPHA, inside_castle_seg7_dl_07035288],
      //[GCMD_ASM,   0, geo_painting_update],
      //[GCMD_ASM, PAINTING_ID, 2, 1], geo_painting_draw],
   [GCMD_CLOSE],
   [GCMD_RETURN],
);

// 0x0E001038
castle_geo_001038 = gList(
   [GCMD_START],
   [GCMD_OPEN],
      [GCMD_DLIST, LAYER_OPAQUE, inside_castle_seg7_dl_07036D88],
      [GCMD_DLIST, LAYER_OPAQUE, inside_castle_seg7_dl_07037988],
      [GCMD_DLIST, LAYER_OPAQUE, inside_castle_seg7_dl_07037BF8],
      [GCMD_DLIST, LAYER_TRANSPARENT, inside_castle_seg7_dl_07037DE8],
      [GCMD_DLIST, LAYER_TRANSPARENT, dl_castle_aquarium_light],
      [GCMD_DLIST, LAYER_ALPHA, inside_castle_seg7_dl_07038350],
      //[GCMD_ASM,   0, geo_painting_update],
      //[GCMD_ASM, PAINTING_ID, 3, 1], geo_painting_draw],
   [GCMD_CLOSE],
   [GCMD_RETURN],
);

// 0x0E001088
castle_geo_001088 = gList(
   [GCMD_START],
   [GCMD_OPEN],
      [GCMD_DLIST, LAYER_OPAQUE, inside_castle_seg7_dl_0703A6C8],
      [GCMD_DLIST, LAYER_ALPHA, inside_castle_seg7_dl_0703A808],
      [GCMD_DLIST, LAYER_OPAQUE, inside_castle_seg7_dl_070234C0],
      [GCMD_DLIST, LAYER_OPAQUE, inside_castle_seg7_dl_07023520],
      //[GCMD_ASM,   0, geo_painting_update],
      //[GCMD_ASM, PAINTING_ID, 1, 1], geo_painting_draw],
   [GCMD_CLOSE],
   [GCMD_RETURN],
);

// 0x0E0010C8
castle_geo_0010C8 = gList(
   [GCMD_START],
   [GCMD_OPEN],
      [GCMD_DLIST, LAYER_OPAQUE, inside_castle_seg7_dl_07028FD0],
      [GCMD_DLIST, LAYER_ALPHA, inside_castle_seg7_dl_07029578],
      ...
      [GCMD_DLIST, LAYER_ALPHA, inside_castle_seg7_dl_0702AB20],
      //[GCMD_ASM, 0, geo_exec_inside_castle_light],
      [GCMD_DLIST, LAYER_OPAQUE, inside_castle_seg7_dl_0703BA08],
   [GCMD_CLOSE],
   [GCMD_RETURN],
);

// 0x0E001110
castle_geo_001110 = gList(
   [GCMD_START],
   [GCMD_OPEN],
      [GCMD_DLIST, LAYER_OPAQUE, inside_castle_seg7_dl_07028FD0],
      [GCMD_DLIST, LAYER_ALPHA, inside_castle_seg7_dl_07029578],
...
castle_geo_001200 = gList(
   ...
   [GCMD_OPEN],
      ...
      [GCMD_DLIST, LAYER_ALPHA, inside_castle_seg7_dl_07033158],
      //[GCMD_ASM,   0, geo_painting_update],
      //[GCMD_ASM, 256, geo_painting_draw],
   [GCMD_CLOSE],
   [GCMD_RETURN],
);

// 0x0E001260
castle_geo_001260 = gList(
   [GCMD_START],
   [GCMD_OPEN],
      [GCMD_DLIST, LAYER_OPAQUE, inside_castle_seg7_dl_07028FD0],
      [GCMD_DLIST, LAYER_ALPHA, inside_castle_seg7_dl_07029578],
      ...
      [GCMD_DLIST, LAYER_ALPHA, inside_castle_seg7_dl_07035288],
      //[GCMD_ASM,   0, geo_painting_update],
      //[GCMD_ASM, 258, geo_painting_draw],
   [GCMD_CLOSE],
   [GCMD_RETURN],
);

// 0x0E0012C8
castle_geo_0012C8 = gList(
   [GCMD_START],
   [GCMD_OPEN],
      [GCMD_DLIST, LAYER_OPAQUE, inside_castle_seg7_dl_07028FD0],
      [GCMD_DLIST, LAYER_ALPHA, inside_castle_seg7_dl_07029578],
...
castle_geo_001400 = gList(
   ...
   [GCMD_OPEN],
      ...
      [GCMD_ZBUFFER, 1],
      [GCMD_OPEN],
         [GCMD_PERSP, 64, 50, 7000, geo_camera_fov],
         [GCMD_OPEN],
            [GCMD_CAMERA, 13, 0, 2000, 6000, 0, 0, 0, geo_camera_main],
            [GCMD_OPEN],
               [GCMD_SWITCH, 17, geo_switch_area],
               [GCMD_OPEN],
                  [GCMD_BRANCH, 1, castle_geo_000F30], // 0x0E000F30
                  [GCMD_BRANCH, 1, castle_geo_000F70], // 0x0E000F70
                  [GCMD_BRANCH, 1, castle_geo_000F88], // 0x0E000F88
                  [GCMD_BRANCH, 1, castle_geo_000FA8], // 0x0E000FA8
                  [GCMD_BRANCH, 1, castle_geo_000FD0], // 0x0E000FD0
                  [GCMD_BRANCH, 1, castle_geo_001000], // 0x0E001000
                  [GCMD_BRANCH, 1, castle_geo_001038], // 0x0E001038
                  [GCMD_BRANCH, 1, castle_geo_001088], // 0x0E001088
                  [GCMD_BRANCH, 1, castle_geo_0010C8], // 0x0E0010C8
                  [GCMD_BRANCH, 1, castle_geo_001110], // 0x0E001110
                  [GCMD_BRANCH, 1, castle_geo_001158], // 0x0E001158
                  [GCMD_BRANCH, 1, castle_geo_0011A8], // 0x0E0011A8
                  [GCMD_BRANCH, 1, castle_geo_001200], // 0x0E001200
                  [GCMD_BRANCH, 1, castle_geo_001260], // 0x0E001260
                  [GCMD_BRANCH, 1, castle_geo_0012C8], // 0x0E0012C8
                  [GCMD_BRANCH, 1, castle_geo_001348], // 0x0E001348
                  [GCMD_BRANCH, 1, castle_geo_0013B8], // 0x0E0013B8
               [GCMD_CLOSE],
               [GCMD_PARENT],
