...
function bbh_script() {
    ...
    //MACRO_OBJECT_END(),
			...
			level_bbh_entry = [			   
				...
				[LCMD_LOAD_MODEL_FROM_GEO, MODEL_BBH_HAUNTED_DOOR,	haunted_door_geo],
				[LCMD_LOAD_MODEL_FROM_GEO, MODEL_MAD_PIANO, mad_piano_geo],
				//[LCMD_LOAD_MODEL_FROM_GEO, MODEL_SCUTTLEBUG, scuttlebug_geo],
			    [LCMD_BEGIN_AREA, 1, geo_bbh_000F00 ],
				...
				[LCMD_TERRAIN, bbh_seg7_collision_level ],
				[LCMD_MACRO_OBJECTS, bbh_seg7_macro_objs ],
				[LCMD_TERRAIN_TYPE, TERRAIN_SPOOKY ],
				[LCMD_ROOMS, bbh_seg7_rooms ],
				[LCMD_END_AREA ],
				[LCMD_FREE_LEVEL_POOL ],
				[LCMD_SET_MARIO_POS,  2, /*yaw*/ 180, /*pos*/ 666, -204, 5350],
