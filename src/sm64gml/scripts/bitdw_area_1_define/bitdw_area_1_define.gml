...
function bitdw_area_1_define(){
/// <pygml?v=1.0&h=14ba50f85>
// 0x07002000 - 0x07002080
bitdw_seg7_vertex_07002000 = vList(
    Vtx([  2516,  -2357,   2962], 0, [   990,      0], [0xff, 0xff, 0xff, 0xff]),
    Vtx([  2415,  -2440,   3024], 0, [     0,    990], [0xff, 0xff, 0xff, 0xff]),
    Vtx([  2517,  -2439,   3023], 0, [   990,    990], [0xff, 0xff, 0xff, 0xff]),
    Vtx([  2413,  -2358,   2962], 0, [     0,      0], [0xff, 0xff, 0xff, 0xff]),
    Vtx([ -3038,  -2766,   2960], 0, [   990,      0], [0xff, 0xff, 0xff, 0xff]),
    Vtx([ -3139,  -2849,   3023], 0, [     0,    990], [0xff, 0xff, 0xff, 0xff]),
    Vtx([ -3037,  -2848,   3022], 0, [   990,    990], [0xff, 0xff, 0xff, 0xff]),
    Vtx([ -3141,  -2768,   2961], 0, [     0,      0], [0xff, 0xff, 0xff, 0xff]),
);

// 0x07002080 - 0x070020C8
bitdw_seg7_dl_07002080 = dList(
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, sTextureUndefined), // @TODO //texture_metal_hole),
    //gsDPLoadSync(),
...
/// <pygml?v=1.0&h=a60670d25>
// 0x0E000618
geo_bitdw_000618 = gList(
   ...
   [GCMD_OPEN],
      ...
      [GCMD_OPEN],
         [GCMD_ORTHO, 100],
         [GCMD_OPEN],
            [GCMD_BACKGROUND, BACKGROUND_GREEN_SKY, geo_skybox_main],
         [GCMD_CLOSE],
      [GCMD_CLOSE],
      [GCMD_ZBUFFER, 1],
      [GCMD_OPEN],
         ...
         [GCMD_OPEN],
            ...
            [GCMD_OPEN],
               [GCMD_DLIST, LAYER_ALPHA, bitdw_seg7_dl_070020C8],
               [GCMD_PARENT],
